...
func (s *S) TestDocumentStartLineComment(c *C) {
	...
	c.Assert(node.Style&yaml.DocumentStartStyle, Not(Equals), yaml.Style(0))
...
func (s *S) TestEmptyDocumentStartLineComment(c *C) {
	...
	c.Assert(first.Style&yaml.DocumentStartStyle, Not(Equals), yaml.Style(0))
	...
	c.Assert(second.Style&yaml.DocumentStartStyle, Not(Equals), yaml.Style(0))
